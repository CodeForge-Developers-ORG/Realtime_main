...
"[project]/src/services/privacyService.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const getPrivacyData = async ()=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$axiosClient$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].get(`/content/site/privacy-policy`);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$privacyService$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/privacyService.ts [app-rsc] (ecmascript)");
...
const metadata = {
    ...
    description: "Read Realtime Biomatrix’s privacy policy on biometric data handling, data protection, and user rights."
};
// ✅ Fetch policy data (server-side)
async function getPrivacyPolicy() {
    try {
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$privacyService$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getPrivacyData"])();
        return res.data;
    } catch (error) {
...
async function PrivacyPolicyPage() {
    ...
    const decodedContent = decodeHTML(policy.content);
    const sanitizedContent = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$privacy$2d$policy$2f$dompurifire$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].sanitize(decodedContent);
    return <invalid> < /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4316a21d._.js.map