...
const getSolutionBySlug = async (slug)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$axiosClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`content/solutions/${slug}`);
    return response.data;
};
}),
...
//# sourceMappingURL=src_858f52b4._.js.map