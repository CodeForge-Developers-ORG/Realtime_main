...
__turbopack_context__.s([
    "baseUri",
    ()=>baseUri,
    "realtimeAppPlayStore",
    ()=>realtimeAppPlayStore,
    "realtimeAppStore",
    ()=>realtimeAppStore
]);
const baseUri = "https://app.realtimebiometrics.net/storage/";
const realtimeAppStore = 'https://apps.apple.com/in/app/realtime-attendance/id1077201553';
const realtimeAppPlayStore = 'https://play.google.com/store/apps/developer?id=REALTIME+BIOMETRICS+INDIA+PRIVATE+LIMITED';
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
