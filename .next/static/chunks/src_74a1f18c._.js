...
function SectionList(param) {
    let { categories, onActiveChange } = param;
    _s();
    ...
    const programmaticScroll = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    // ✅ FIX HERE — use `number | null` instead of `NodeJS.Timeout`
    const scrollEndTimeout = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
                ...
                "SectionList.useEffect.handler": (e)=>{
                    ...
                    if (typeof idx === "number") {
                        ...
                        if (el && containerRef.current) {
                            ...
                            const topOffset = el.getBoundingClientRect().top + window.scrollY - ((_containerRef_current_offsetTop = containerRef.current.offsetTop) !== null && _containerRef_current_offsetTop !== void 0 ? _containerRef_current_offsetTop : 0) - 8;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SectionList.useEffect": ()=>{
            const handleScroll = {
                "SectionList.useEffect.handleScroll": ()=>{
                    if (programmaticScroll.current) {
                        ...
                        }["SectionList.useEffect.handleScroll"], 100);
                    }
                }
            }["SectionList.useEffect.handleScroll"];
...
_s(SectionList, "NZ8xTou2QnHMMzOiUgNfxvyf2kY=");
_c = SectionList;
var _c;
...
_s(Sidebar, "zaggShcpTudlSySTlzxLwD4qHHA=");
_c = Sidebar;
var _c;
...
function CatalogClient() {
    ...
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const [scrollYBeforeLoad, setScrollYBeforeLoad] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
            ...
            const observer = new IntersectionObserver({
                "CatalogClient.useEffect": (entries)=>{
                    ...
                    if (first.isIntersecting && hasMore && !loading && isScrollingDown && now - lastTrigger > 800 // throttle 800ms
                        ...
                        setTimeout({
                            "CatalogClient.useEffect": ()=>setPage({
                                    "CatalogClient.useEffect": (prev)=>prev + 1
                                }["CatalogClient.useEffect"])
                        }["CatalogClient.useEffect"], 300);
                    }
                }
            }["CatalogClient.useEffect"], {
                threshold: 1,
...
_s(CatalogClient, "CqHwSD1wjkd8rtcG6s5j9ZMrh7Y=");
_c = CatalogClient;
var _c;
...
//# sourceMappingURL=src_74a1f18c._.js.map