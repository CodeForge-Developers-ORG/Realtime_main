...
"[project]/src/components/blog/BlogFilters.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"use client";
;
const BlogFilters = (param)=>{
    let { onFilterChange, categories, loading = false } = param;
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BlogFilters.useEffect": ()=>{
            const timer = setTimeout({
                "BlogFilters.useEffect.timer": ()=>{
                    setLocalFilters({
                        "BlogFilters.useEffect.timer": (prev)=>({
                                ...prev,
                                search: searchInput
                            })
                    }["BlogFilters.useEffect.timer"]);
                }
            }["BlogFilters.useEffect.timer"], 500);
            return ({
                "BlogFilters.useEffect": ()=>clearTimeout(timer)
            })["BlogFilters.useEffect"];
        }
    }["BlogFilters.useEffect"], [
        searchInput
            ...
            hasActiveFilters && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        localFilters.search && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                        ...
                        localFilters.category && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_s(BlogFilters, "OyGjtdh159zf3RhmCoMMebDpyCE=");
_c = BlogFilters;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$blog$2f$BlogFilters$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/blog/BlogFilters.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
const BlogList = ()=>{
    ...
    const fetchBlogs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BlogList.useCallback[fetchBlogs]": async (currentFilters)=>{
            try {
                setLoading(true);
                setError(null);
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$blogService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["blogService"].getBlogs(currentFilters);
    ...
    }["BlogList.useCallback[fetchBlogs]"], []);
    // Debounce effect for filters
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BlogList.useEffect": ()=>{
            const timer = setTimeout({
                "BlogList.useEffect.timer": ()=>{
                    fetchBlogs(filters);
                }
            }["BlogList.useEffect.timer"], 300); // 300ms debounce
            return ({
                "BlogList.useEffect": ()=>clearTimeout(timer)
            })["BlogList.useEffect"];
        }
    }["BlogList.useEffect"], [
        filters,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BlogList.useEffect": ()=>{
            const initializeData = {
                "BlogList.useEffect.initializeData": async ()=>{
                    try {
                        setLoading(true);
                        const [blogsResponse] = await Promise.all([
                            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$blogService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["blogService"].getBlogs()
                        ]);
                        setBlogs(blogsResponse.data);
                        const uniqueCategories = [
                            ...new Set(blogsResponse.data.map({
                                "BlogList.useEffect.initializeData": (blog)=>blog.category
                            }["BlogList.useEffect.initializeData"]))
                        ];
    ...
    const handleFilterChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BlogList.useCallback[handleFilterChange]": (newFilters)=>{
            setFilters(newFilters);
        }
    }["BlogList.useCallback[handleFilterChange]"], []);
    const retryLoading = ()=>{
        fetchBlogs(filters);
    };
    if (error) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$blog$2f$BlogFilters$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
            ...
            !loading && blogs.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        (filters.search || filters.category) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            onClick: ()=>setFilters({}),
...
_s(BlogList, "Lbu9f2Cg29gxdonMyI4oiOrWAxA=");
_c = BlogList;
...
//# sourceMappingURL=src_7fc8a6ff._.js.map