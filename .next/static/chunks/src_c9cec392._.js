...
;
;
const SolutionDetailPage = (param)=>{
    let { params } = param;
    _s();
        ...
        "SolutionDetailPage.useEffect": ()=>{
            const fetchSolution = {
                "SolutionDetailPage.useEffect.fetchSolution": async ()=>{
                    ...
                    const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$solutionServices$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSolutionBySlug"])(params.title);
...
_s(SolutionDetailPage, "TWlLMDOrQRrjrZYBibtoISDiqTs=");
...
//# sourceMappingURL=src_c9cec392._.js.map