...
"[project]/src/app/products/category/[id]/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getProductsByCategory(categoryId) {
    ...
    const res = await fetch("https://app.realtimebiometrics.net/api/content/products?category_id=".concat(categoryId, "&page=").concat(page), {
        cache: "no-store"
    });
...
function CategoryPage() {
    var _products__category, _products_, _products__category1, _products_1;
    _s();
    ...
    const loadProducts = async (pageNum)=>{
        try {
            setLoading(true);
            const res = await getProductsByCategory(id, pageNum);
            const newProducts = (res === null || res === void 0 ? void 0 : res.data) || [];
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CategoryPage.useEffect": ()=>{
            ...
            const observer = new IntersectionObserver({
                "CategoryPage.useEffect": (entries)=>{
                    const first = entries[0];
                    if (first.isIntersecting && hasMore && !loading) {
                        setPage({
                            "CategoryPage.useEffect": (prev)=>prev + 1
                        }["CategoryPage.useEffect"]);
                    }
                }
            }["CategoryPage.useEffect"], {
            ...
            return ({
                "CategoryPage.useEffect": ()=>observer.disconnect()
            })["CategoryPage.useEffect"];
        }
    }["CategoryPage.useEffect"], [
        hasMore,
    ...
    const categoryName = ((_products_ = products[0]) === null || _products_ === void 0 ? void 0 : (_products__category = _products_.category) === null || _products__category === void 0 ? void 0 : _products__category.name) || "Products";
    const breadcrumbItems = [
        ...
        {
            label: ((_products_1 = products[0]) === null || _products_1 === void 0 ? void 0 : (_products__category1 = _products_1.category) === null || _products__category1 === void 0 ? void 0 : _products__category1.name) || "Category",
            href: "/products/category/".concat(id)
        }
    ];
                        ...
                        children: products.map((it)=>{
                            ...
                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$products$2f$Card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                    it: {
                                        name: it.title,
                                        image: ((_it_images = it.images) === null || _it_images === void 0 ? void 0 : _it_images[0]) || "/no-image.jpg"
                                    }
                                }, void 0, false, {
                                    fileName: "[project]/src/app/products/category/[id]/page.tsx",
                                    lineNumber: 122,
...
_s(CategoryPage, "ZzTfleMxQ0N3Arv0EJdS0/+6Rxs=", false, function() {
    return [
...
//# sourceMappingURL=src_d9f548fc._.js.map