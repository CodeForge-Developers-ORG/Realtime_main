...
const softwares: Software[] = [
  ...
  { name: "Realtime Attendance Tracker v11.8", version: "v11.8", note: "🔥 New" },
  { name: "Realtime Attendance Tracker v11.7", version: "v11.7" },
  { name: "Attendance Tracker 11.7 (UP Paramedical Attendance System)", version: "11.7" },
  ...
  { name: "Realsoft 11.6 (July 2022) with All Pro models", version: "11.6-2022" },
  ...
  { name: "Attendance Tracker (18 digit Enrollment Number)", version: "18digit" },
];
